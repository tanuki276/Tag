...
class WorldGenerator:
    ...
    def _generate_map(self, config: dict) -> MapManager:
        ...
        # Simple Cellular Automata for organic wall structures
    ...
    def _spawn_entities(self, mgr: MapManager, config: dict) -> dict:
        ...
        # Initialize Onis (Distant from Humans)
        o_count = config["entities"]["oni"]["count"]
        for i in range(o_count):
            if not empty_cells: break
            # Select position with maximum minimum distance to any human
